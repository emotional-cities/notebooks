...
def custom_schema(root: Union[str, ComplexPath],
    ...
    #streams.Glia.EyeTracking.Data =               GliaEyeTrackingStream(215, device='Glia', streamlabel='Glia.EyeTracking.Data', root=root, autoload=autoload, parent_dataset=parent_dataset)
    ...
    streams.Glia.HeartRate =                 GliaHeartRateStream(216, device='Glia',
    ...
    streams.Glia.IMU =                       GliaImuStream(217, device='Glia', streamlabel='Glia.IMU.Data', root=root, autoload=autoload, parent_dataset=parent_dataset)
    ...
    streams.Unity.Transform =                 UnityTransformStream(219, device='Unity', streamlabel='Unity.Transform.Data', root=root, autoload=autoload, parent_dataset=parent_dataset)
    ...
    #streams.Unity.ITI.Timestamps =                 HarpStream(226, device='Unity', streamlabel='Unity.ITI.Timestamps'   , root=root, autoload=autoload, parent_dataset=parent_dataset)
    streams.Unity.ITI =                            ProtocolItiStream(226, device='Unity', streamlabel='Unity.ITI.Data'   , root=root, autoload=autoload, parent_dataset=parent_dataset)

    streams.Unity.PointToOriginWorld =        ProtocolPointToOriginWorldStream(227, device='Unity', streamlabel='Unity.PointToOriginWorld.Data', root=root, autoload=autoload, parent_dataset=parent_dataset)
    ...
    streams.Unity.PointToOriginMap =          ProtocolPointToOriginMapStream(228, device='Unity', streamlabel='Unity.PointToOriginMap.Data', root=root, autoload=autoload, parent_dataset=parent_dataset)
    ...
    #streams.Unity.SceneSequence.Timestamps =       HarpStream(225, device='Unity', streamlabel='Unity.NewScene.Timestamps', root=root, autoload=autoload, parent_dataset=parent_dataset)
    streams.Unity.SceneSequence =             ProtocolNewSceneStream(225, device='Unity', streamlabel='Unity.SceneSequence', root=root, autoload=autoload, parent_dataset=parent_dataset)
    streams.Unity.Georeference =             UnityGeoreferenceStream(211, device='Unity', streamlabel='Unity.Georeference', root=root, autoload=autoload, parent_dataset=parent_dataset)
